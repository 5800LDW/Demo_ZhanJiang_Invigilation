...
class TakePhotoForAddStudentActivity : MyBaseActivity() {
    ...
    override fun getLayoutId(): Int {
        return R.layout.activity_register_take_photo_for_add_student
    }
...
//            })
    ...
    override fun onDestroy() {
        ...
        LogUtil.e(">>>>>>>>>>>>>>>>>>>>> TakePhotoForAddStudentActivity onDestroy()")
    }
...
//        }
        ...
        try {
            mCamera!!.autoFocus(Camera.AutoFocusCallback { success, camera ->
                ...
                if (isopen_camara) {
                    if (!isTakingPhoto) {
                        isTakingPhoto = true
                        if (handler == null) {
                            handler = SafeHandler(this@TakePhotoForAddStudentActivity, object : HandlerCallback {
            ...
            LogUtil.e(">>>>>>>>>>>>>>>>>>> TakePhotoForAddStudentActivity 发生报错")
            LogUtil.e(e)
        }
...
//                    //TODO
//                    val intent = Intent(
//                        this@TakePhotoForAddStudentActivity,
...
//                    val intent = Intent(this@TakePhotoForAddStudentActivity, PhotoConfirActivity::class.java)
...
//                    saveFilePath(jpgFile1.toString())
                    ...
                    val intent = Intent(this@TakePhotoForAddStudentActivity, PhotoConfirmActivityForAddStudent::class.java)
    ...
    private inner class LockScreenReceiver : BroadcastReceiver() {
        override fun onReceive(context: Context?, intent: Intent?) {
            this@TakePhotoForAddStudentActivity.finish()
        }
    }
...
//        ApplyPreviewBuilder.setPicPeopleP(path)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        when (resultCode) {
            10012 -> {
                val intent = Intent(this@TakePhotoForAddStudentActivity, AddNewStudentActivity::class.java)
