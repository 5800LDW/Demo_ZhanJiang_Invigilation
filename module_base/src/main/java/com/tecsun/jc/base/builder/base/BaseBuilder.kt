package com.tecsun.jc.base.builder.base
...
open class BaseBuilder{
    ...
    protected fun getBitmapByFileName1(fileName: String?): Bitmap? {
        fileName?.let {
    ...
    protected fun getBitmapByFileName2(fileName: String): Bitmap? {
    ...
    protected fun getBitmapByFilePathWithName(sfzh: String): Bitmap? {
        val fileName = sfzh + ".png"
        val filePath = getFilePath()
        val file = File(filePath + File.separator, fileName)

        LogUtil.e(">>>>>>>>>>>>>>> 拿取的图片的绝对路径: $file")
//        val file = File(filePathWithName)
     ...
     fun getBitmapAbsolutePath(sfzh: String):String?{
         val fileName = sfzh + ".png"
         val filePath = getFilePath()
         val file = File(filePath + File.separator, fileName)
     ...
     * @return
     */
    protected fun saveImage(bitmap: Bitmap, sfzh: String): String {
    ...
    protected fun deleteImageByFilePath(filePathWithName: String) {
    ...
    open fun getFilePath(): String {
        ...
        return JinLinApp.context!!.getExternalFilesDir("base_pic").absolutePath
    }

    protected fun deleteImageBySFZH(sfzh: String) {
        sfzh?.let {
            val filePath = getFilePath()
