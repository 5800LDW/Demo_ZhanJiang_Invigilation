 ...
 * @date 2019/9/12
 */
object StudentTeacherTakeImageBuilder {
    ...
    fun getBitmapByFilePathWithName(sfzh: String): Bitmap? {
...
//        val file = File(filePathWithName)
    ...
    private fun getFilePath(): String {
        return JinLinApp.context!!.getExternalFilesDir("teacher_take").absolutePath
    }
